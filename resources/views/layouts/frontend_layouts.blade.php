...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('frontendAsset') }}/assets/img/favicon.ico"/>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700" rel="stylesheet">
    <link href="{{ asset('frontendAsset') }}/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="{{ asset('frontendAsset') }}/assets/css/plugins.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL {{ asset('frontendAsset') }}/plugins/CUSTOM STYLES -->
    <link href="{{ asset('frontendAsset') }}/assets/css/ecommerce-dashboard/timeline.css" rel="stylesheet" type="text/css" />
    <link href="{{ asset('frontendAsset') }}/assets/css/ecommerce-dashboard/style.css" rel="stylesheet" type="text/css" />
    <!-- BEGIN PAGE LEVEL {{ asset('frontendAsset') }}/plugins/CUSTOM STYLES -->
...
<body>
    ...
    <header class="tabMobileView header navbar fixed-top d-lg-none">
        <div class="nav-toggle">
            ...
            <a href="index.html" class=""> <img src="{{ asset('frontendAsset') }}/assets/img/logo-3.png" class="img-fluid" alt="logo"></a>
        </div>
        ...
        <ul class="navbar-nav flex-row">
            <li class="nav-item dropdown language-dropdown ml-1  ml-lg-0">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="flagDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ asset('frontendAsset') }}/assets/img/ca.svg" alt=""> <span class="d-lg-inline-block d-none"></span>
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="flagDropdown">
                    <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('frontendAsset') }}/assets/img/de.svg" class="flag-width" alt=""> &#xA0;German</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('frontendAsset') }}/assets/img/jp.svg" class="flag-width" alt=""> &#xA0;Japanese</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('frontendAsset') }}/assets/img/fr.svg" class="flag-width" alt=""> &#xA0;French</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('frontendAsset') }}/assets/img/ru.svg" class="flag-width" alt=""> &#xA0;Russian</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('frontendAsset') }}/assets/img/ca.svg" class="flag-width" alt=""> &#xA0;English</a>
                </div>
            </li>
        </ul>
                    ...
                    <a class="dropdown-item" href="javascript:void(0);">
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle" src="{{ asset('frontendAsset') }}/assets/img/90x90.jpg" alt="Generic placeholder image">
                            </div>
                    ...
                    <a class="dropdown-item text-center  p-1" href="javascript:void(0);">
                        ...
                        <div class="notification-list ">
                            ...
                            <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="{{ asset('frontendAsset') }}/assets/img/90x90.jpg" alt="admin-profile" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="{{ asset('frontendAsset') }}/assets/img/90x90.jpg" alt="admin-profile">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="{{ asset('frontendAsset') }}/assets/img/90x90.jpg" alt="admin-profile">
                                    </li>
                            ...
                            <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="{{ asset('frontendAsset') }}/assets/img/90x90.jpg" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="{{ asset('frontendAsset') }}/assets/img/90x90.jpg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="{{ asset('frontendAsset') }}/assets/img/90x90.jpg">
                                    </li>
                ...
                <ul class="navbar-nav theme-brand flex-row  d-none d-lg-flex">
                    <li class="nav-item d-flex">
                        <a href="index.html" class="navbar-brand">
                            <img src="{{ asset('frontendAsset') }}/assets/img/logo-3.png" class="img-fluid" alt="logo">
                        </a>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="usr-info text-center mb-5">
                        <img alt="admin-profile" src="{{ asset('frontendAsset') }}/assets/img/120x120.jpg" class="img-fluid rounded-circle mb-3">
                        <div class=" mt-2">
                ...
                <div id="feeds-tab" class="tab-pane tab-1 fade show active">
                    ...
                    <div class="tasks">
                        ...
                        <div class="recent">
                            ...
                            <div class="media">
                                <img alt="admin-profile" src="{{ asset('frontendAsset') }}/assets/img/120x120.jpg" class="img-fluid mr-3">
                                <div class="media-body">
                    ...
                    <div class="friends">
                        ...
                        <div class="recent">
                            ...
                            <ul class="list-inline text-center mb-5">
                                ...
                                <li class="list-inline-item">
                                    <img alt="admin-profile" src="{{ asset('frontendAsset') }}/assets/img/120x120.jpg">
                        ...
                        <div class="online mt-5">
                            ...
                            <div class="media d-block d-sm-flex text-sm-left text-center">
                                <img alt="admin-profile" class="mr-sm-3 mb-sm-0 mb-3" src="{{ asset('frontendAsset') }}/assets/img/120x120.jpg">
                            ...
                            <div class="media d-block d-sm-flex text-sm-left text-center">
                                <img alt="admin-profile" class="mr-sm-3 mb-sm-0 mb-3 rounded" src="{{ asset('frontendAsset') }}/assets/img/120x120.jpg">
                                <div class="media-body mb-4">
                            ...
                            <div class="media d-block d-sm-flex text-sm-left text-center">
                                <img alt="admin-profile" class="mr-sm-3 mb-sm-0 mb-3 rounded-circle" src="{{ asset('frontendAsset') }}/assets/img/120x120.jpg">
                                <div class="media-body mb-4">
                            ...
                            <div class="a-s-media mb-5">
                                ...
                                <div class="media mb-3">
                                    <div class="profile-img mr-3">
                                        <img alt="admin-profile" src="{{ asset('frontendAsset') }}/assets/img/90x90.jpg" class="img-fluid">
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media mb-3">
                                    <div class="profile-img mr-3">
                                        <img alt="admin-profile" src="{{ asset('frontendAsset') }}/assets/img/120x120.jpg" class="img-fluid">
                                    </div>
                                    <div class="media-body">
    ...
    <script src="{{ asset('frontendAsset') }}/plugins/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="{{ asset('frontendAsset') }}/assets/js/app.js"></script>
    <script>
    ...
    <!-- BEGIN PAGE LEVEL {{ asset('frontendAsset') }}/plugins/CUSTOM SCRIPTS -->
    <script src="{{ asset('frontendAsset') }}/assets/js/ui-kit/timeline/horizontal-main.js"></script>
    <script src="{{ asset('frontendAsset') }}/plugins/progressbar/progressbar.min.js"></script>
    <script src="{{ asset('frontendAsset') }}/plugins/charts/amcharts/amcharts.js"></script>
    <script src="{{ asset('frontendAsset') }}/plugins/maps/vector/ammaps/ammap_amcharts_extension.js"></script>
    <script src="{{ asset('frontendAsset') }}/plugins/maps/vector/ammaps/worldLow.js"></script>
    <script src="{{ asset('frontendAsset') }}/plugins/charts/amcharts/radar.js"></script>
    <script src="{{ asset('frontendAsset') }}/plugins/charts/amcharts/pie.js"></script>
    <script src="{{ asset('frontendAsset') }}/plugins/charts/sparklines/jquery.sparkline.min.js"></script>
    <script src="{{ asset('frontendAsset') }}/plugins/charts/amcharts/serial.js"></script>
    <script src="{{ asset('frontendAsset') }}/plugins/charts/amcharts/light.js"></script>
    <script src="{{ asset('frontendAsset') }}/assets/js/ecommerce-dashboard/ecommerce-custom.js"></script>
